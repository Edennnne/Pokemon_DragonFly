...
inventaire = pygame.image.load("images/inventaire.jpg").convert()
inventaire = pygame.transform.scale(inventaire, (taille_ecran))
ecran.blit(inventaire,(500,500))

# on charge l'icône de l'inventaire en bas à gauche de l'écran
icone_inventaire = pygame.image.load("images/boutonX.png").convert()
icone_inventaire = pygame.transform.scale(icone_inventaire, (50,50))
icone_inventaire.set_colorkey([0,0,0])


# création du personnage, changement de ses mesures
perso = pygame.image.load("images/perso_dracaufeu-1.png").convert()
largeur_perso = 40
longueur_perso = 40
...
ecran.blit(perso,(200,200)) # on affiche le perso aux coordonnées marquées
...
while jeu_en_cours :
    ...
    ecran.blit(inventaire,(0,-25))
    ecran.blit(icone_inventaire,(longueur_ecran-67 ,largeur_ecran-38))
