...
icone_inventaire = pygame.image.load("images/tab.png").convert_alpha()
icone_inventaire = pygame.transform.scale(icone_inventaire, (80,75))

icone_entrer = pygame.image.load("images/boutonEntrer.png").convert_alpha()
icone_entrer = pygame.transform.scale(icone_entrer, (190,55))

imgacc = pygame.image.load("images/start screen.png").convert_alpha()
imgacc = pygame.transform.scale(imgacc, (taille_ecran))
...
icone_esc = pygame.transform.scale(icone_esc, (50,50))

# création du personnage, changement de ses mesures
perso = pygame.image.load("images/perso.png").convert()
largeur_perso = 40
longueur_perso = 40
...
while jeu_en_cours :
    ...
    # on réaffiche tout
    if ecran_accueil == True:
        ecran.blit(imgacc,(0,0))
    else:
        if inventaire == True:
            
            ecran.blit(fond_inventaire,(0,0))
            ecran.blit(icone_esc,(longueur_ecran-55 ,largeur_ecran-55))
            ecran.blit(icone_entrer,(longueur_ecran-250 ,largeur_ecran-59))
            
            
        else:
            ecran.blit(fond,(0,0))
            ecran.blit(perso,position_perso)
            ecran.blit(icone_sac,(longueur_ecran-100 ,largeur_ecran-130))
            ecran.blit(icone_inventaire,(longueur_ecran-110 ,largeur_ecran-80))
